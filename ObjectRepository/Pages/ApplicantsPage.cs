    ...
    public class ApplicantsPage : BasePage
    {
        ...
        public void JointEmploymentInfo(Employee emp)
        {
            if (co_2_employertxt.Displayed())
                co_2_employertxt.SendKeysWrapper(emp.Employer, driver);
            if (co_2_occupation.Displayed())
                co_2_occupation.SendKeysWrapper(emp.Occupation, driver);
            if (co_2_monthly_salary.Displayed())
                co_2_monthly_salary.SendKeysWrapper("500", driver);
            if (co_2_employment_start_date.Displayed())
                co_2_employment_start_date.SendKeysWrapper("12/12/2012", driver, true);
        ...
        public void PrimaryEmploymentInfo(Employee emp)
        {
            ...
            if (pri_monthly_salary.Displayed())
                pri_monthly_salary.SendKeysWrapper("500", driver);
            if (pri_employment_start_date.Displayed())
                pri_employment_start_date.SendKeysWrapper("12/12/2012", driver,true);
        ...
        public void PrimaryDetails(ICollection details)
        {
            ...
            if (pri_gender.Displayed())
                pri_gender.SelectComboBox(null, driver);
            ...
            if (pri_cell_phone.Displayed())
                pri_cell_phone.SendKeysWrapper(Parameter.Get<string>("Cell"), driver, true);
            if (pri_primary_phone.Displayed())
                pri_primary_phone.SendKeysWrapper(Parameter.Get<string>("Cell"), driver, true);
            if (pri_years_at_address.Displayed())
                pri_years_at_address.SendKeysWrapper("5", driver, true);
            if (pri_months_at_address.Displayed())
                pri_months_at_address.SendKeysWrapper("5", driver, true);
            if (pri_rent.Displayed())
                pri_rent.SelectComboBox(Parameter.Get<string>("Resisency"), driver);
            if (pri_phone_type.Displayed())
                pri_phone_type.SelectDropDown(driver, Parameter.Get<string>("PhoneType"));
            pri_email_address.SendKeysWrapper(Parameter.Get<string>("Email"), driver,true);
        ...
        public void AddJointOwner(ICollection details)
        {
            ...
            if (co_2_months_at_address.Displayed())
                co_2_months_at_address.SendKeysWrapper("5", driver, true);
            if (co_2_rent.Displayed())
                co_2_rent.SelectComboBox(Parameter.Get<string>("Resisency"), driver);
            if (co_2_primary_phone.Displayed())
            {
                co_2_primary_phone.SendKeysWrapper(Parameter.Get<string>("Cell"), driver, true);
                co_2_phone_type.SelectDropDown(driver, Parameter.Get<string>("PhoneType"));
            }
            if (co_2_cell_phone.Displayed())
            {
                co_2_cell_phone.SendKeysWrapper(Parameter.Get<string>("Cell"), driver, true);
                co_2_home_phone.SendKeysWrapper(Parameter.Get<string>("Cell"), driver, true);
            }
        ...
        public void AddBeneficiary(ICollection details)
        {
            ...
            bene_ssn_0.SendKeysWrapper(details.SSN, driver, true);
        ...
        public void PrimaryDetailsWithdDrivingLicense(ICollection details)
        {
            ...
            if (pri_cell_phone.Displayed())
                pri_cell_phone.SendKeysWrapper(details.Phone, driver, true);
            if (pri_primary_phone.Displayed())
            {
                pri_primary_phone.SendKeysWrapper(details.Phone, driver, true);
                pri_phone_type.SelectDropDown(driver, Parameter.Get<string>("PhoneType"));
            }
        ...
        private void IdentificationType(string type, ICollection details = null)
        {
            ...
            pri_identificaton_number.SendKeysWrapper(details.DLNumber, driver, true);
            switch (selectedType)
            {
                ...
                case "Driver's License":
                    ...
                    pri_idissue_date.SendKeysWrapper(Parameter.Get<string>("IssueDate"), driver, true);
                    pri_id_exp_date.SendKeysWrapper(Parameter.Get<string>("ExpDate"), driver, true);
                    break;
                case "State ID Card":
                case "US Passport":
        ...
        private void Eligibility()
        {
            ...
            if (eligibility_zip.Displayed())
                eligibility_zip.SendKeysWrapper(Parameter.Get<string>("County"), driver);
            if (eligibility_employer_church_work.Displayed())
                eligibility_employer_church_work.SendKeysWrapper(Parameter.Get<string>("Test"), driver);
            if (continu.Displayed())
                continu.ClickCustom(driver);
            if (FindBy(By.Id("mfa-submit"), 1).Displayed())
                FindBy(By.Id("mfa-submit"), 1).ClickCustom(driver);
        }
    }
}
